...
const Contact = () => {
  ...
  return (
    <>
      ...
      />
      {/* Desktop */}
      <div id='contact' className='bg-tertiary h-[545px] md:mx-14 md:mt-10 rounded-md p-10 sm:flex sm:flex-row hidden content-between gap-x-2'>
        ...
        <div className='right relative w-1/2 h-full rounded-md text-black'>
          <form ref={form} onSubmit={sendEmail}>
            <div className='mt-10 ml-10'> 
              <label htmlFor='name' className='text-white'>Your Name</label><br />
            ...
            <input type="submit" className="bg-violet-800 hover-bg-green-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 my-2 cursor-pointer float-right mr-16" value="Send message" />
            {/* <button onClick={sendEmail}  >Send message</button> */}
          </form>
        </div>
      </div>
      {/* Phone */}
      <div className='sm:hidden bg-tertiary h-[600px] mx-5 rounded-lg overflow-hidden'>
        ...
        <div className='down w-full h-full my-2'>
          <div className=' bg-slate-50 rounded-md text-black overflow-hidden'>
            <form ref={form} onSubmit={sendEmail}>
              ...
              <input type="submit" className="bg-violet-800 hover-bg-green-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 my-2 mx-2" value="Send message" />
              {/* <button onClick={sendEmail}  >Send message</button> */}
            </form>
          </div>
        </div>
